...
fn main() {
    ...
    App::new().title("Egor Desk Fan Demo").run(move |FrameContext { gfx, timer, .. }| {
        let speed = 5.8;
        ...
        for i in 0..4 {
            ...
            gfx.path()
                ...
                .cubic_to(vec2(tip_x - r + r * k, -r), vec2(tip_x, -r + r * k), vec2(tip_x, 0.0))
                .cubic_to(vec2(tip_x, r - r * k), vec2(tip_x - r + r * k, r), vec2(tip_x - r, r))
                .line_to(vec2(0.0, r))
                .close();
        }
